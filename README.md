...
- [minishell](https://github.com/IcaroJam/Cursus42/tree/master/minishell): Mi personal (s)hell, done together with @phijano. I was in charge of coding the builtins and the parser. The executor and signal handling is courtesy of my partner. 
